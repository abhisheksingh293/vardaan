          ...
          {[
            {
              ...
              classNotes: () => window.open('/studymaterial/Class9EconomicsTheStoryOfVillagePalampurClassNotes'),
              chapterNotes: () => window.open('/studymaterial/Class9EconomicsTheStoryOfVillagePalampurChapterNotes'),
              mindMaps: () => window.open('/studymaterial/Class9EconomicsTheStoryOfVillagePalampurMindMaps'),
              practiceQuestions: () => window.open('/studymaterial/Class9EconomicsTheStoryOfVillagePalampurPracticeQuestions')
            },
            {
              num: '02',
              title: 'People as Resources',
              classNotes: () => window.open('/studymaterial/class9EconomicsPeopleAsResourcesClassNotes'),
              chapterNotes: () => window.open('/studymaterial/class9EconomicsPeopleAsResourcesChapterNotes'),
              mindMaps: () => window.open('/studymaterial/class9EconomicsPeopleAsResourcesMindMaps'),
              practiceQuestions: () => window.open('/studymaterial/class9EconomicsPeopleAsResourcesPracticeQuestions')
            },
            {
              num: '03',
              title: ' Poverty as a Challenge',
              classNotes: () => window.open('/studymaterial/Class9EconomicsPovertyAsAChallengeClassNotes'),
              chapterNotes: () => window.open('/studymaterial/Class9EconomicsPovertyAsAChallengeChapterNotes'),
              mindMaps: () => window.open('/studymaterial/Class9EconomicsPovertyAsAChallengeMindMaps'),
              practiceQuestions: () => window.open('/studymaterial/Class9EconomicsPovertyAsAChallengePracticeQuestions')
            },
            {
              num: '04',
              title: 'Food Security in India',
              classNotes: () => window.open('/studymaterial/Class9EconomicsFoodSecurityinIndiaClassNotes'),
              chapterNotes: () => window.open('/studymaterial/Class9EconomicsFoodSecurityinIndiaChapterNotes'),
              mindMaps: () => window.open('/studymaterial/Class9EconomicsFoodSecurityinIndiaMindMaps'),
              practiceQuestions: () => window.open('/studymaterial/Class9EconomicsFoodSecurityinIndiaPracticeQuestions')
            },
...
export default Class9Economics;
