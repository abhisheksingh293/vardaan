          ...
          {[
            {
              ...
              classNotes: () => window.open('/studymaterial/class9/civics/Class9CivicsWhatIsDemocracyWhyDemocracyClassNotes'),
              chapterNotes: () => window.open('/studymaterial/class9/civics/Class9CivicsWhatIsDemocracyWhyDemocracyChapterNotes'),
              mindMaps: () => window.open('/studymaterial/class9/civics/Class9CivicsWhatIsDemocracyWhyDemocracyMindMaps'),
              practiceQuestions: () => window.open('/studymaterial/class9/civics/Class9CivicsWhatIsDemocracyWhyDemocracyPracticeQuestions')
            },
            {
              num: '02',
              title: 'The CONSTITUTIONAL DESIGN',
              classNotes: () => window.open('/studymaterial/class9/civics/Class9CivicsTheConstitutionalDesignClassNotes'),
              chapterNotes: () => window.open('/studymaterial/class9/civics/Class9CivicsTheConstitutionalDesignChapterNotes'),
              mindMaps: () => window.open('/studymaterial/class9/civics/Class9CivicsTheConstitutionalDesignMindMaps'),
              practiceQuestions: () => window.open('/studymaterial/class9/civics/Class9CivicsTheConstitutionalDesignPracticeQuestions')
            },
            {
              num: '03',
              title: 'WORKING OF INSTITUTIONS',
              classNotes: () => window.open('/studymaterial/class9/civics/Class9CivicsWorkingofInstitutionsClassNotes'),
              chapterNotes: () => window.open('/studymaterial/class9/civics/Class9CivicsWorkingofInstitutionsChapterNotes'),
              mindMaps: () => window.open('/studymaterial/class9/civics/Class9CivicsWorkingofInstitutionsMindMaps'),
              practiceQuestions: () => window.open('/studymaterial/class9/civics/Class9CivicsWorkingofInstitutionsPracticeQuestions')
            },
            {
              num: '04',
              title: 'DEMOCRATIC RIGHTS',
              classNotes: () => window.open('/studymaterial/class9/civics/Class9CivicsDemocraticRightsClassNotes'),
              chapterNotes: () => window.open('/studymaterial/class9/civics/Class9CivicsDemocraticRightsChapterNotes'),
              mindMaps: () => window.open('/studymaterial/class9/civics/Class9CivicsDemocraticRightsMindMaps'),
              practiceQuestions: () => window.open('/studymaterial/class9/civics/Class9CivicsDemocraticRightsPracticeQuestions')
            },
          ].map((chapter, idx) => (
