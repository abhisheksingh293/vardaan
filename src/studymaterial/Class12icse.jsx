...
//   const handleScienceClick = () => navigate('/studymaterial/class12icse/Class12icseScience');
//   const handleMathematicsClick = () => navigate('/studymaterial/class12icse/Class12icseMathematics');
//   const handleSocialScienceClick = () => navigate('/studymaterial/class12icse/Class12icseSocialScience');
//   const handleEnglishClick = () => navigate('/studymaterial/class12icse/Class12icseEnglish');
//   const handleEnglishGrammarClick = () => navigate('/studymaterial/class12icse/Class12icseEnglishGrammar');
...
//             <h3 className="text-lg sm:text-xl font-semibold text-gray-900 text-center mb-2">Science Class 12 ICSE</h3>
//           </button>
...
//             <h3 className="text-lg sm:text-xl font-semibold text-gray-900 text-center mb-2">Mathematics Class 12 ICSE</h3>
//           </button>
...
//             <h3 className="text-lg sm:text-xl font-semibold text-gray-900 text-center mb-2">Social Studies Class 12 ICSE</h3>
//           </button>
...
//             <h3 className="text-lg sm:text-xl font-semibold text-gray-900 text-center mb-2">English Class 12 ICSE</h3>
//           </button>
