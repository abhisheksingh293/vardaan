...
const Class7icse = () => {
  ...
  const handleScienceClick = () => navigate('/studymaterial/class7icse/Class7icseScience');
  const handleMathematicsClick = () => navigate('/studymaterial/class7icse/Class7icseMathematics');
  const handleGeographyClick = () => navigate('/studymaterial/class7icse/Class7icseGeography');
      ...
      <section className="max-w-6xl mx-auto mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          <button onClick={handleScienceClick} className="flex flex-col items-center p-6 bg-white rounded-xl shadow-lg border border-orange-100 hover:shadow-xl hover:scale-105 transition-all duration-300 transform focus:outline-none focus:ring-4 focus:ring-orange-300 focus:ring-opacity-75">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 text-center mb-2">Science Class 7 ICSE</h3>
          </button>
          <button onClick={handleMathematicsClick} className="flex flex-col items-center p-6 bg-white rounded-xl shadow-lg border border-orange-100 hover:shadow-xl hover:scale-105 transition-all duration-300 transform focus:outline-none focus:ring-4 focus:ring-orange-300 focus:ring-opacity-75">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 text-center mb-2">Mathematics Class 7 ICSE</h3>
          </button>
          <button onClick={handleGeographyClick} className="flex flex-col items-center p-6 bg-white rounded-xl shadow-lg border border-orange-100 hover:shadow-xl hover:scale-105 transition-all duration-300 transform focus:outline-none focus:ring-4 focus:ring-orange-300 focus:ring-opacity-75">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 text-center mb-2">Geography Class 7 ICSE</h3>
          </button>
          <button onClick={handleCivicsHistoryClick} className="flex flex-col items-center p-6 bg-white rounded-xl shadow-lg border border-orange-100 hover:shadow-xl hover:scale-105 transition-all duration-300 transform focus:outline-none focus:ring-4 focus:ring-orange-300 focus:ring-opacity-75">
            <img src="https://res.cloudinary.com/dxwszplz7/image/upload/v1757176494/civics_and_history_nl6lnm.jpg" alt="Civics & History Icon" className="w-36 h-36 mb-4 rounded-lg shadow-md" />
            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 text-center mb-2">Civics & History Class 7 ICSE</h3>
          </button>
          <button onClick={handleEnglishClick} className="flex flex-col items-center p-6 bg-white rounded-xl shadow-lg border border-orange-100 hover:shadow-xl hover:scale-105 transition-all duration-300 transform focus:outline-none focus:ring-4 focus:ring-orange-300 focus:ring-opacity-75">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 text-center mb-2">English Class 7 ICSE</h3>
          </button>
