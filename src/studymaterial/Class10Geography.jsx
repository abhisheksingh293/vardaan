...
const Class10Geography = () => {
  ...
  const goToNcertPdf01 = () => { window.location.href = `https://ncert.nic.in/textbook/pdf/jess101.pdf`; };
  const goToNcertSolution01 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyResourcesAndDevelopment`; };
  const goToPreviousYearQuestions01 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyResourcesAndDevelopment`; };
  const goToChapterNotes01 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyResourcesAndDevelopment`; };
  const goToClassNotes01 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyResourcesAndDevelopmentClassNotes`; };
  const goToMindMap01 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyResourcesAndDevelopment`; };

  // Chapter 02: Forest and Wildlife Resources
  const goToNcertPdf02 = () => { window.location.href = `https://ncert.nic.in/textbook/pdf/jess102.pdf`; };
  const goToNcertSolution02 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyForestandWildlifeResources`; };
  const goToPreviousYearQuestions02 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyForestandWildlifeResources`; };
  const goToChapterNotes02 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyForestandWildlifeResources`; };
  const goToClassNotes02 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyForestandWildlifeResourcesClassNotes`; };
  const goToMindMap02 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyForestandWildlifeResources`; };

  // Chapter 03: Water Resources
  const goToNcertPdf03 = () => { window.location.href = `https://ncert.nic.in/textbook/pdf/jess103.pdf`; };
  const goToNcertSolution03 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyWaterResources`; };
  const goToPreviousYearQuestions03 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyWaterResources`; };
  const goToChapterNotes03 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyWaterResources`; };
  const goToClassNotes03 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyWaterResourcesClassNotes`; };
  const goToMindMap03 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyWaterResources`; };

  // Chapter 04: Agriculture
  const goToNcertPdf04 = () => { window.location.href = `https://ncert.nic.in/textbook/pdf/jess104.pdf`; };
  const goToNcertSolution04 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyAgriculture`; };
  const goToPreviousYearQuestions04 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyAgriculture`; };
  const goToChapterNotes04 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyAgriculture`; };
  const goToClassNotes04 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyAgricultureClassNotes`; };
  const goToMindMap04 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyAgriculture`; };

  // Chapter 05: Minerals and Energy Resources
  const goToNcertPdf05 = () => { window.location.href = `https://ncert.nic.in/textbook/pdf/jess105.pdf`; };
  const goToNcertSolution05 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyMineralsAndEnergyResources`; };
  const goToPreviousYearQuestions05 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyMineralsAndEnergyResources`; };
  const goToChapterNotes05 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyMineralsAndEnergyResources`; };
  const goToClassNotes05 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyMineralsAndEnergyResourcesClassNotes`; };
  const goToMindMap05 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyMineralsAndEnergyResources`; };

  // Chapter 06: Manufacturing Industries
  const goToNcertPdf06 = () => { window.location.href = `https://ncert.nic.in/textbook/pdf/jess106.pdf`; };
  const goToNcertSolution06 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyManufacturingIndustries`; };
  const goToPreviousYearQuestions06 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyManufacturingIndustries`; };
  const goToChapterNotes06 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyManufacturingIndustries`; };
  const goToClassNotes06 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyManufacturingIndustriesClassNotes`; };
  const goToMindMap06 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyManufacturingIndustries`; };

  // Chapter 07: Lifelines of National Economy
  const goToNcertPdf07 = () => { window.location.href = `https://ncert.nic.in/textbook/pdf/jess107.pdf`; };
  const goToNcertSolution07 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyLifelinesOfNationalEconomy`; };
  const goToPreviousYearQuestions07 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyLifelinesOfNationalEconomy`; };
  const goToChapterNotes07 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyLifelinesOfNationalEconomy`; };
  const goToClassNotes07 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyLifelinesOfNationalEconomyClassNotes`; };
  const goToMindMap07 = () => { window.location.href = `/studymaterial/class10/Class10Geography/Class10GeographyLifelinesOfNationalEconomy`; };
            ...
            <button className="w-full flex items-center justify-between p-4 sm:p-5 cursor-pointer hover:bg-orange-50 transition-colors duration-200" onClick={() => toggleChapter('01')}>
              <div className="flex items-center">
                ...
                <div className="text-left">
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900">Resources and Development</h3>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-md border border-orange-100 overflow-hidden">
            <button className="w-full flex items-center justify-between p-4 sm:p-5 cursor-pointer hover:bg-orange-50 transition-colors duration-200" onClick={() => toggleChapter('02')}>
              <div className="flex items-center">
                ...
                <div className="text-left">
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900">Forest and Wildlife Resources</h3>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-md border border-orange-100 overflow-hidden">
            <button className="w-full flex items-center justify-between p-4 sm:p-5 cursor-pointer hover:bg-orange-50 transition-colors duration-200" onClick={() => toggleChapter('03')}>
              <div className="flex items-center">
                ...
                <div className="text-left">
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900">Water Resources</h3>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-md border border-orange-100 overflow-hidden">
            <button className="w-full flex items-center justify-between p-4 sm:p-5 cursor-pointer hover:bg-orange-50 transition-colors duration-200" onClick={() => toggleChapter('04')}>
              <div className="flex items-center">
                ...
                <div className="text-left">
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900">Agriculture   </h3>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-md border border-orange-100 overflow-hidden">
            <button className="w-full flex items-center justify-between p-4 sm:p-5 cursor-pointer hover:bg-orange-50 transition-colors duration-200" onClick={() => toggleChapter('05')}>
              <div className="flex items-center">
                ...
                <div className="text-left">
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900">Minerals and Energy Resources</h3>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-md border border-orange-100 overflow-hidden">
            <button className="w-full flex items-center justify-between p-4 sm:p-5 cursor-pointer hover:bg-orange-50 transition-colors duration-200" onClick={() => toggleChapter('06')}>
              <div className="flex items-center">
                ...
                <div className="text-left">
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900">Manufacturing Industries</h3>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-md border border-orange-100 overflow-hidden">
            <button className="w-full flex items-center justify-between p-4 sm:p-5 cursor-pointer hover:bg-orange-50 transition-colors duration-200" onClick={() => toggleChapter('07')}>
              <div className="flex items-center">
                ...
                <div className="text-left">
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900">Lifelines of National Economy</h3>
                </div>
              </div>
...
export default Class10Geography;