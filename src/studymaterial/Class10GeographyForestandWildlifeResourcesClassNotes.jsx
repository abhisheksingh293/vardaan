    ...
    sections: [
      {
        ...
        content: [
          { type: 'paragraph', text: '<strong>Biodiversity:</strong> The huge variety of living organisms, from micro-organisms to large animals, all interconnected in a complex web.' },
          { type: 'paragraph', text: '<strong>Why It\'s Important:</strong> We depend on this system for our survival—it creates the clean air, water, and soil we need.' },
          { type: 'paragraph', text: '<strong>Forests:</strong> They are the primary producers in the ecosystem, meaning all other life depends on them.' }
        ]
      },
      {
        id: '2',
        title: "The Need for Conservation",
        content: [
          { type: 'heading', text: 'Why Conserve?:'},
          { type: 'list', items: [
              'To protect our life-support systems (air, water, soil) and ecological diversity.',
              'To preserve the genetic diversity of plants and animals, which is crucial for agriculture and fisheries.'
          ]}
        ]
      },
      {
        id: '3',
        title: "Government Conservation Efforts",
        content: [
            { type: 'heading', text: 'The Indian Wildlife (Protection) Act, 1972:'},
            { type: 'list', items: [
                'Launched to protect habitats and wildlife.',
                'Banned hunting, gave legal protection to habitats, and restricted trade in wildlife.',
                'An all-India list of protected species was published.'
            ]},
            { type: 'heading', text: 'Project Tiger (1973):'},
            { type: 'list', items: [
                'Launched because the tiger population had dropped drastically from ~55,000 to just 1,827 by 1973.',
                'Major threats: Poaching, shrinking habitats, and a decrease in prey.',
                'Tiger Reserves: Corbett, Sunderbans, Bandhavgarh, Sariska, Manas, and Periyar are key examples.'
            ]},
            { type: 'paragraph', text: '<strong>Broader Focus:</strong> Conservation now includes insects (butterflies, moths, beetles) and plants.'}
        ]
      },
      {
          id: '4',
          ...
          content: [
              { type: 'paragraph', text: 'Forests managed by the government are classified into three types:'},
              { type: 'list', items: [
                  '<strong>Reserved Forests:</strong><br/>o More than half of all forests.<br/>o Considered the most valuable for conservation.',
                  '<strong>Protected Forests:</strong><br/>o Almost one-third of all forests.<br/>o Protected from any further depletion.',
                  '<strong>Unclassed Forests:</strong><br/>o Other forests and wastelands belonging to government, communities, or individuals.<br/>o Common in North-eastern states and parts of Gujarat, managed by local communities.'
              ]}
          ]
      },
      {
        id: '5',
        title: "Community Role in Conservation",
        content: [
            { type: 'paragraph', text: '<strong>Local Involvement:</strong> Many local communities are actively working to protect forests and wildlife to secure their own livelihoods.'},
            { type: 'heading', text: 'Key Examples:'},
            { type: 'list', items: [
                '<strong>Bhairodev Dakav \'Sonchuri\' (Alwar, Rajasthan):</strong> Villagers declared 1,200 hectares of forest for protection with their own rules, banning hunting.',
                '<strong>The Chipko Movement:</strong> Successfully resisted deforestation in the Himalayas and promoted community afforestation.',
                '<strong>Beej Bachao Andolan (Tehri):</strong> Showed that diversified crop production is possible without synthetic chemicals.',
                '<strong>Joint Forest Management (JFM):</strong> A program where local communities help manage and restore degraded forests in partnership with the Forest Department. In return, they get benefits like non-timber forest products.',
                '<strong>Sacred Groves:</strong> Forests protected by communities due to religious beliefs (Forests of Gods and Goddesses), where interference is banned. For example, the Mundas and Santhals worship Mahua and Kadamba trees.'
            ]}
        ]
      }
    ]
    ...
    sections: [
      {
        ...
        title: "Biodiversity and Its Importance",
        content: [
          { type: 'paragraph', text: '<strong>Biodiversity:</strong> Micro-organisms se lekar bade janwaron tak, sabhi jeevit praniyon ki vishal vividhta, jo ek jatil jaal mein ek doosre se judi hui hai.' },
          { type: 'paragraph', text: '<strong>Yeh Kyun Zaroori Hai:</strong> Hum apne astitva ke liye is system par nirbhar hain—yeh hamare liye saaf hawa, paani aur mitti banata hai.' },
          { type: 'paragraph', text: '<strong>Forests:</strong> Ve ecosystem mein primary producers hain, jiska matlab hai ki baaki sabhi jeevan un par nirbhar hai.' }
        ]
      },
      {
        id: '2',
        title: "The Need for Conservation",
        content: [
          { type: 'heading', text: 'Kyun Sanrakshit Karein?:'},
          { type: 'list', items: [
              'Apne life-support systems (hawa, paani, mitti) aur ecological diversity ko bachane ke liye.',
              'Paudhon aur janwaron ki genetic diversity ko sanrakshit karne ke liye, jo agriculture aur fisheries ke liye mahatvapurna hai.'
          ]}
        ]
      },
      {
        ...
        content: [
            { type: 'heading', text: 'The Indian Wildlife (Protection) Act, 1972:'},
            { type: 'list', items: [
                'Habitats aur wildlife ko protect karne ke liye launch kiya gaya.',
                'Shikar par ban lagaya, habitats ko kanooni suraksha di, aur wildlife trade ko restrict kiya.',
                'Protected species ki ek all-India list publish ki gayi.'
            ]},
            { type: 'heading', text: 'Project Tiger (1973):'},
            { type: 'list', items: [
                'Launch kiya gaya kyunki tiger population 1973 tak ~55,000 se ghatkar sirf 1,827 reh gayi thi.',
                'Bade khatre: Poaching, sikudte habitats, aur shikar mein kami.',
                'Tiger Reserves: Corbett, Sunderbans, Bandhavgarh, Sariska, Manas, aur Periyar iske mukhya udaharan hain.'
            ]},
            { type: 'paragraph', text: '<strong>Broader Focus:</strong> Conservation mein ab keede-makode (titliyan, patange, bhramare) aur paudhe bhi shamil hain.'}
        ]
      },
      {
          id: '4',
          title: 'Types of Forests in India',
          content: [
              { type: 'paragraph', text: 'Sarkar dwara manage kiye jaane wale forests ko teen types mein classify kiya gaya hai:'},
              { type: 'list', items: [
                  '<strong>Reserved Forests:</strong><br/>o Sabhi forests ka aadhe se zyada.<br/>o Conservation ke liye sabse valuable maane jaate hain.',
                  '<strong>Protected Forests:</strong><br/>o Sabhi forests ka lagbhag one-third.<br/>o Kisi bhi aur kami se surakshit.',
                  '<strong>Unclassed Forests:</strong><br/>o Sarkar, samudayon ya vyaktiyon ke anya van aur banjar bhoomi.<br/>o North-eastern states aur Gujarat ke kuch hisson mein aam, sthaniya samudayon dwara manage kiye jaate hain.'
              ]}
          ]
      },
      {
        ...
        title: "Community Role in Conservation",
        content: [
            { type: 'paragraph', text: '<strong>Local Involvement:</strong> Kai sthaniya samuday apni ajeevika surakshit karne ke liye vanon aur vany jeevon ki suraksha ke liye sakriya roop se kaam kar rahe hain.'},
            { type: 'heading', text: 'Key Examples:'},
            { type: 'list', items: [
                '<strong>Bhairodev Dakav \'Sonchuri\' (Alwar, Rajasthan):</strong> Gaonwalon ne apne niyamon ke saath suraksha ke liye 1,200 hectare van ghoshit kiya, shikar par rok laga di.',
                '<strong>The Chipko Movement:</strong> Himalayas mein vanon ki katai ka safaltapoorvak virodh kiya aur samudayik vanikaran ko badhava diya.',
                '<strong>Beej Bachao Andolan (Tehri):</strong> Dikhaya ki synthetic chemicals ke bina vividh fasal utpadan sambhav hai.',
                '<strong>Joint Forest Management (JFM):</strong> Ek karyakram jahan sthaniya samuday Van Vibhag ke saath sajhedari mein kharab vanon ko prabandhit aur punah sthapit karne mein madad karte hain. Badle mein, unhein gair-imarti van utpad jaise labh milte hain.',
                '<strong>Sacred Groves:</strong> Dharmik vishvason ke kaaran samudayon dwara sanrakshit van (Devi-Devtaon ke Van), jahan hastakshep varjit hai. Udaharan ke liye, Munda aur Santhal Mahua aur Kadamba ke pedon ki pooja karte hain.'
            ]}
        ]
      }
    ]
...
// Main App Component
function Class10GeographyForestandWildlifeResourcesClassNotes() {
...
export default Class10GeographyForestandWildlifeResourcesClassNotes;
