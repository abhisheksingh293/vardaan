...
const Class9SocialScience = () => {
  ...
  const handleAdditionalResourcesClick = () => navigate('/studymaterial/class9/Class9AdditionalResources');
  ...
  return (
    <div className="mt-17 min-h-screen bg-gradient-to-br from-orange-50 to-orange-100 p-4 sm:p-6 font-inter text-gray-800">
      ...
      <section className="max-w-6xl mx-auto mb-12">
        ...
        <button onClick={handleAdditionalResourcesClick} className="flex flex-col items-center p-6 bg-white rounded-xl shadow-lg border border-orange-100 hover:shadow-xl hover:scale-105 transition-all duration-300 transform focus:outline-none focus:ring-4 focus:ring-orange-300 focus:ring-opacity-75">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 text-center mb-2">Additional Resources</h3>
          </button>
