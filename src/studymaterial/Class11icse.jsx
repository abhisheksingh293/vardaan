...
//   const handleScienceClick = () => navigate('/studymaterial/class11icse/Class11icseScience');
//   const handleMathematicsClick = () => navigate('/studymaterial/class11icse/Class11icseMathematics');
//   const handleSocialScienceClick = () => navigate('/studymaterial/class11icse/Class11icseSocialScience');
//   const handleEnglishClick = () => navigate('/studymaterial/class11icse/Class11icseEnglish');
//   const handleEnglishGrammarClick = () => navigate('/studymaterial/class11icse/Class11icseEnglishGrammar');
...
//             <h3 className="text-lg sm:text-xl font-semibold text-gray-900 text-center mb-2">Science Class 11 ICSE</h3>
//           </button>
...
//             <h3 className="text-lg sm:text-xl font-semibold text-gray-900 text-center mb-2">Mathematics Class 11 ICSE</h3>
//           </button>
...
//             <h3 className="text-lg sm:text-xl font-semibold text-gray-900 text-center mb-2">Social Studies Class 11 ICSE</h3>
//           </button>
...
//             <h3 className="text-lg sm:text-xl font-semibold text-gray-900 text-center mb-2">English Class 11 ICSE</h3>
//           </button>
