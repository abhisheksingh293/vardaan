...
const Class10Civics = () => {
  ...
  const goToNcertPdf01 = () => { window.location.href = `https://ncert.nic.in/textbook/pdf/jess401.pdf`; };
  ...
  const goToNcertPdf02 = () => { window.location.href = `https://ncert.nic.in/textbook/pdf/jess402.pdf`; };
  ...
  const goToNcertPdf03 = () => { window.location.href = `https://ncert.nic.in/textbook/pdf/jess403.pdf`; };
  const goToNcertSolution03 = () => { window.location.href = ``; };
  const goToPreviousYearQuestions03 = () => { window.location.href = ``; };
  const goToChapterNotes03 = () => { window.location.href = `/Studymaterial/Class10/Class10Civics/Class10CivicsGenderReligionandCaste`; };
  const goToMindMap03 = () => { window.location.href = ``; };

  // Chapter 04: Political Parties
  const goToNcertPdf04 = () => { window.location.href = `https://ncert.nic.in/textbook/pdf/jess404.pdf`; };
  ...
  const goToNcertPdf05 = () => { window.location.href = `https://ncert.nic.in/textbook/pdf/jess405.pdf`; };
            ...
            <button className="w-full flex items-center justify-between p-4 sm:p-5 cursor-pointer hover:bg-orange-50 transition-colors duration-200" onClick={() => toggleChapter('01')}>
              <div className="flex items-center">
                ...
                <div className="text-left">
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900">Power-sharing</h3>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-md border border-orange-100 overflow-hidden">
            <button className="w-full flex items-center justify-between p-4 sm:p-5 cursor-pointer hover:bg-orange-50 transition-colors duration-200" onClick={() => toggleChapter('02')}>
              <div className="flex items-center">
                ...
                <div className="text-left">
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900">Federalism</h3>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-md border border-orange-100 overflow-hidden">
            <button className="w-full flex items-center justify-between p-4 sm:p-5 cursor-pointer hover:bg-orange-50 transition-colors duration-200" onClick={() => toggleChapter('03')}>
              <div className="flex items-center">
                ...
                <div className="text-left">
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900">Gender, Religion and Caste</h3>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-md border border-orange-100 overflow-hidden">
            <button className="w-full flex items-center justify-between p-4 sm:p-5 cursor-pointer hover:bg-orange-50 transition-colors duration-200" onClick={() => toggleChapter('04')}>
              <div className="flex items-center">
                ...
                <div className="text-left">
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900">Political Parties</h3>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-md border border-orange-100 overflow-hidden">
            <button className="w-full flex items-center justify-between p-4 sm:p-5 cursor-pointer hover:bg-orange-50 transition-colors duration-200" onClick={() => toggleChapter('05')}>
              <div className="flex items-center">
                ...
                <div className="text-left">
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900">Outcomes of Democracy</h3>
                </div>
              </div>
