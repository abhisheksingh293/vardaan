...
//   return (
//     <div className="mt-17 min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 p-4 sm:p-6 font-inter text-gray-800">
//       <style>{`
...
//       `}</style>
//       <header className="relative flex flex-col items-center justify-center mb-10 py-12 px-6 bg-gradient-to-br from-blue-500 via-blue-400 to-indigo-300 rounded-3xl shadow-2xl border-2 border-blue-200 overflow-hidden">
...
//           Choose your ICSE subject and start learning!
//         </p>
//         <button
//           className="relative z-10 mt-2 px-6 py-2 bg-white text-blue-600 font-semibold rounded-full shadow hover:bg-blue-50 transition"
...
//           <button onClick={handleScienceClick} className="flex flex-col items-center p-6 bg-white rounded-xl shadow-lg border border-blue-100 hover:shadow-xl hover:scale-105 transition-all duration-300 transform focus:outline-none focus:ring-4 focus:ring-blue-300 focus:ring-opacity-75">
...
//           </button>
//           <button onClick={handleMathematicsClick} className="flex flex-col items-center p-6 bg-white rounded-xl shadow-lg border border-blue-100 hover:shadow-xl hover:scale-105 transition-all duration-300 transform focus:outline-none focus:ring-4 focus:ring-blue-300 focus:ring-opacity-75">
...
//           </button>
//           <button onClick={handleSocialScienceClick} className="flex flex-col items-center p-6 bg-white rounded-xl shadow-lg border border-blue-100 hover:shadow-xl hover:scale-105 transition-all duration-300 transform focus:outline-none focus:ring-4 focus:ring-blue-300 focus:ring-opacity-75">
...
//           </button>
//           <button onClick={handleEnglishClick} className="flex flex-col items-center p-6 bg-white rounded-xl shadow-lg border border-blue-100 hover:shadow-xl hover:scale-105 transition-all duration-300 transform focus:outline-none focus:ring-4 focus:ring-blue-300 focus:ring-opacity-75">
...
//           </button>
//           <button onClick={handleEnglishGrammarClick} className="flex flex-col items-center p-6 bg-white rounded-xl shadow-lg border border-blue-100 hover:shadow-xl hover:scale-105 transition-all duration-300 transform focus:outline-none focus:ring-4 focus:ring-blue-300 focus:ring-opacity-75">
//             <img src="/SubjectLogo/GrammarLanguage.png" alt="English Grammar Advanced Icon" className="w-36 h-36 mb-4 rounded-lg shadow-md" />
//             <h3 className="text-lg sm:text-xl font-semibold text-gray-900 text-center mb-2">English Grammar ICSE</h3>
//           </button>
//         </div>
//       </section>
//     </div>
