...
const Class10icse = () => {
  ...
  const handleScienceClick = () => navigate('/studymaterial/class10icse/Class10icseScience');
  const handleMathematicsClick = () => navigate('/studymaterial/class10icse/Class10icseMathematics');
  const handleEnglishClick = () => navigate('/studymaterial/class10icse/Class10icseEnglish');
  const handleEnglishGrammarClick = () => navigate('/studymaterial/class10icse/Class10icseEnglishGrammar');
  const handleHistoryClick = () => navigate('/studymaterial/class10icse/Class10icseHistory');
  const handleGeographyClick = () => navigate('/studymaterial/class10icse/Class10icseGeography');
  const handleCivicsClick = () => navigate('/studymaterial/class10icse/Class10icseCivics');
