    ...
    sections: [
      {
        ...
        content: [
          { type: 'list', items: [
              'We act as both producers (when we work) and consumers (when we buy).',
              'Rules are needed to protect consumers from exploitation, just like they are for workers and borrowers.',
              'Consumer exploitation happens through unfair trade practices like underweighting goods, adding hidden charges, and selling defective or adulterated products.',
              'Large, powerful companies can manipulate markets with false advertising. A well-known example is a company that falsely claimed its baby milk powder was better than mother\'s milk.'
          ]}
        ]
      },
      {
        ...
        content: [
          { type: 'list', items: [
              'The movement began due to consumer dissatisfaction with unfair practices by sellers.',
              'In India, it became organized in the 1960s because of issues like food shortages, hoarding, and black marketing.',
              'A major step was the Indian government\'s enactment of the Consumer Protection Act of 1986 (COPRA).'
          ]}
        ]
      },
      {
        id: '3',
        title: "Key Consumer Rights",
        content: [
            { type: 'list', items: [
                '<strong>Right to Safety:</strong> Protection against goods and services hazardous to life and property. Producers must follow safety rules.',
                '<strong>Right to be Informed:</strong> The right to have information about the quality, quantity, purity, price, and standard of goods or services. Look for details like MRP, ingredients, and expiry date. The Right to Information (RTI) Act (2005) allows citizens to get information from government departments.',
                '<strong>Right to Choose:</strong> Freedom to choose from a variety of products and services at competitive prices. You cannot be forced to buy a product you don\'t want.',
                '<strong>Right to Seek Redressal:</strong> The right to get compensation for damage caused by unfair trade practices. COPRA set up a three-tier quasi-judicial system for this:<br/>1. <strong>District Commission:</strong> For claims up to ₹1 crore.<br/>2. <strong>State Commission:</strong> For claims between ₹1 crore and ₹10 crore.<br/>3. <strong>National Commission:</strong> For claims exceeding ₹10 crore.'
            ]}
        ]
      },
      {
          ...
          content: [
              { type: 'list', items: [
                  'Consumer awareness is key. The government runs campaigns like "Jago Grahak Jago" to educate consumers.',
                  'Look for quality certification marks:<br/>o <strong>ISI:</strong> For industrial and durable consumer goods.<br/>o <strong>Agmark:</strong> For agricultural and food products.<br/>o <strong>Hallmark:</strong> For purity of gold jewellery.'
              ]}
          ]
      },
      {
        id: '5',
        title: "The Consumer Movement: Progress and Challenges",
        content: [
            { type: 'list', items: [
                'India observes December 24 as National Consumers\' Day.',
                '<strong>Challenges:</strong> The redressal process can be slow, expensive, and complicated. Getting evidence, like a cash memo, is often difficult.',
                '<strong>COPRA Amendment (2019):</strong> Strengthened the act by including internet purchases and holding manufacturers directly responsible.',
                'The movement\'s success depends on the active participation of consumers.'
            ]}
        ]
      }
    ]
    ...
    sections: [
      {
        ...
        content: [
          { type: 'list', items: [
              'Hum producers (jab hum kaam karte hain) aur consumers (jab hum khareedte hain) dono ke roop mein act karte hain.',
              'Consumers ko exploitation se bachane ke liye rules zaroori hain, jaise workers aur borrowers ke liye hote hain.',
              'Consumer exploitation unfair trade practices ke through hota hai jaise kam tolna, hidden charges lagana, aur defective ya milawati products bechna.',
              'Badi, powerful companies false advertising se markets ko manipulate kar sakti hain. Ek famous example ek company ka hai jisne jhootha dawa kiya ki uska baby milk powder maa ke doodh se behtar hai.'
          ]}
        ]
      },
      {
        ...
        content: [
          { type: 'list', items: [
              'Yeh movement sellers ki unfair practices se consumer ke dissatisfaction ke kaaran shuru hua.',
              'India mein, yeh 1960s mein food shortages, hoarding, aur black marketing jaise issues ke kaaran organized hua.',
              'Ek bada kadam Indian government dwara Consumer Protection Act of 1986 (COPRA) ka laagoo karna tha.'
          ]}
        ]
      },
      {
        ...
        content: [
            { type: 'list', items: [
                '<strong>Right to Safety:</strong> Jaan aur sampatti ke liye khatarnak goods aur services ke khilaf suraksha. Producers ko safety rules follow karne chahiye.',
                '<strong>Right to be Informed:</strong> Goods ya services ki quality, quantity, purity, price, aur standard ke baare mein jaankari paane ka adhikar. Packaging par MRP, ingredients, aur expiry date jaise details dekhein. Right to Information (RTI) Act (2005) citizens ko government departments se jaankari prapt karne ki anumati deta hai.',
                '<strong>Right to Choose:</strong> Competitive prices par vibhinn products aur services mein se chunne ki azaadi. Aapko koi aisi product khareedne ke liye force nahi kar sakta jo aap nahi chahte.',
                '<strong>Right to Seek Redressal:</strong> Unfair trade practices se hue nuksan ke liye compensation paane ka adhikar. COPRA ne iske liye ek three-tier quasi-judicial system sthapit kiya hai:<br/>1. <strong>District Commission:</strong> ₹1 crore tak ke claims ke liye.<br/>2. <strong>State Commission:</strong> ₹1 crore se ₹10 crore ke beech ke claims ke liye.<br/>3. <strong>National Commission:</strong> ₹10 crore se अधिक ke claims ke liye.'
            ]}
        ]
      },
      {
          ...
          content: [
              { type: 'list', items: [
                  'Consumer awareness sabse zaroori hai. Sarkar consumers ko educate karne ke liye "Jago Grahak Jago" jaise campaigns chalati hai.',
                  'Quality certification marks dekhein:<br/>o <strong>ISI:</strong> Industrial aur durable consumer goods ke liye.<br/>o <strong>Agmark:</strong> Agricultural aur food products ke liye.<br/>o <strong>Hallmark:</strong> Sone ke aabhushano ki shuddhta ke liye.'
              ]}
          ]
      },
      {
        ...
        content: [
            { type: 'list', items: [
                'India 24 December ko National Consumers\' Day manata hai.',
                '<strong>Challenges:</strong> Redressal process dheema, mehenga, aur jatil ho sakta hai. Cash memo jaise saboot ikattha karna aksar mushkil hota hai.',
                '<strong>COPRA Amendment (2019):</strong> Isne internet khareedari ko shaamil karke aur manufacturers ko seedhe zimmedar thehrate hue act ko mazboot kiya.',
                'Movement ki safalta consumers ke active participation par depend karti hai.'
            ]}
        ]
      }
    ]
