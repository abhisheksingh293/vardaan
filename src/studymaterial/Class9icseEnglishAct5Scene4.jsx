...
import Class9icseEnglishAct5Scene4Summary from './Class9icseEnglishAct5Scene4Summary';
import Class9icseEnglishAct5Scene4Questions from './Class9icseEnglishAct5Scene4Questions';
...
// Data for the scene
const galleryImages = ["https://placehold.co/400x400/8B0000/FFFFFF?text=Lucillius+as+Brutus", "https://placehold.co/400x400/A52A2A/FFFFFF?text=The+Fall+of+Young+Cato", "https://placehold.co/400x400/DAA520/FFFFFF?text=Antony+Spares+Lucillius", "https://placehold.co/400x400/3B3B3B/FFFFFF?text=A+Noble+Prisoner"];
const importantWords = [
    { term: "Proclaim", definition: "To announce something publicly or officially." },
    { term: "Tyrant", definition: "A cruel and oppressive ruler." },
    { term: "Yield", definition: "To surrender or give way under pressure." },
    { term: "Chanced", definition: "Happened or occurred, especially by chance." },
];


const dialogueVersions = {
    Shakespearean: [
        { speaker: 'BRUTUS', lines: 'Yet, countrymen, O, yet hold up your heads!' },
        { speaker: 'CATO', lines: 'What bastard doth not? Who will go with me?\nI will proclaim my name about the field.\nI am the son of Marcus Cato, ho!\nA foe to tyrants, and my country’s friend.\nI am the son of Marcus Cato, ho!' },
        { speaker: 'LUCILLIUS', lines: 'And I am Brutus, Marcus Brutus, I!\nBrutus, my country’s friend. Know me for Brutus!' },
        { speaker: 'LUCILLIUS', lines: 'O young and noble Cato, art thou down?\nWhy, now thou diest as bravely as Titinius,\nAnd mayst be honored, being Cato’s son.' },
        { speaker: 'FIRST SOLDIER', lines: 'Yield, or thou diest.' },
        { speaker: 'LUCILLIUS', lines: 'Only I yield to die.\nThere is so much that thou wilt kill me straight.\nKill Brutus, and be honored in his death.' },
        { speaker: 'FIRST SOLDIER', lines: 'We must not. A noble prisoner!' },
        { speaker: 'SECOND SOLDIER', lines: 'Room, ho! Tell Antony Brutus is ta\'en.' },
        { speaker: 'FIRST SOLDIER', lines: 'I’ll tell the news. Here comes the general.\n—Brutus is ta\'en, Brutus is ta\'en, my lord.' },
        { speaker: 'ANTONY', lines: 'Where is he?' },
        { speaker: 'LUCILLIUS', lines: 'Safe, Antony. Brutus is safe enough.\nI dare assure thee that no enemy\nShall ever take alive the noble Brutus.\nThe gods defend him from so great a shame!\nWhen you do find him, or alive or dead,\nHe will be found like Brutus, like himself.' },
        { speaker: 'ANTONY', lines: 'This is not Brutus, friend, but, I assure you,\nA prize no less in worth. Keep this man safe.\nGive him all kindness. I had rather have\nSuch men my friends than enemies. Go on,\nAnd see whether Brutus be alive or dead.\nAnd bring us word unto Octavius\' tent,\nHow everything is chanced.' },
    ],
    'Normal English': [
        { speaker: 'BRUTUS', lines: 'My countrymen, oh, keep your heads up!' },
        { speaker: 'CATO', lines: 'What cowardly person would not? Who will come with me?\nI will shout my name across the battlefield.\nI am the son of Marcus Cato!\nAn enemy to tyrants, and a friend to my country.\nI am the son of Marcus Cato!' },
        { speaker: 'LUCILLIUS', lines: 'And I am Brutus, Marcus Brutus, me!\nBrutus, my country’s friend. Know that I am Brutus!' },
        { speaker: 'LUCILLIUS', lines: 'Oh young and noble Cato, have you fallen?\nWell, now you die as bravely as Titinius,\nAnd you can be honored, as Cato’s son.' },
        { speaker: 'FIRST SOLDIER', lines: 'Surrender, or you will die.' },
        { speaker: 'LUCILLIUS', lines: 'I will only surrender to die.\nThere is so much honor in it that you will want to kill me immediately.\nKill Brutus, and be honored for his death.' },
        { speaker: 'FIRST SOLDIER', lines: 'We must not kill him. He is a noble prisoner!' },
        { speaker: 'SECOND SOLDIER', lines: 'Make way! Tell Antony that Brutus has been captured.' },
        { speaker: 'FIRST SOLDIER', lines: 'I’ll tell him the news. Here comes the general.\n—Brutus is captured, Brutus is captured, my lord.' },
        { speaker: 'ANTONY', lines: 'Where is he?' },
        { speaker: 'LUCILLIUS', lines: 'He is safe, Antony. Brutus is safe enough.\nI can promise you that no enemy\nwill ever take the noble Brutus alive.\nMay the gods protect him from such a great shame!\nWhen you find him, whether he is alive or dead,\nhe will be found as he should be, as himself.' },
        { speaker: 'ANTONY', lines: 'This is not Brutus, friend, but I assure you,\nhe is a prize of no less value. Keep this man safe.\nShow him every kindness. I would rather have\nmen like him as my friends than as my enemies. Go on,\nand find out if Brutus is alive or dead,\nand bring the news to Octavius’s tent\nof how everything has turned out.' },
    ],
    Hinglish: [
        { speaker: 'BRUTUS', lines: 'Mere deshwasio, abhi bhi, O, abhi bhi apne sir upar rakho!' },
        { speaker: 'CATO', lines: 'Kaun kamzor hai jo aisa nahi karega? Mere saath kaun chalega?\nMain maidan mein apna naam ghoshit karunga.\nMain Marcus Cato ka beta hoon, ho!\nAtyachariyon ka dushman, aur apne desh ka dost.\nMain Marcus Cato ka beta hoon, ho!' },
        { speaker: 'LUCILLIUS', lines: 'Aur main Brutus hoon, Marcus Brutus, main!\nBrutus, mere desh ka dost. Mujhe Brutus ke naam se jaano!' },
        { speaker: 'LUCILLIUS', lines: 'O yuva aur mahan Cato, kya tum gir gaye?\nKyun, ab tum utni hi bahaduri se mar rahe ho jaise Titinius,\nAur sammanit ho sakte ho, Cato ka beta hone ke naate.' },
        { speaker: 'FIRST SOLDIER', lines: 'Hathiyar daal do, ya tum mar jaoge.' },
        { speaker: 'LUCILLIUS', lines: 'Main sirf marne ke liye hathiyar daalta hoon.\nItna sammaan hai ki tum mujhe turant maar doge.\nBrutus ko maaro, aur uski maut mein sammaan pao.' },
        { speaker: 'FIRST SOLDIER', lines: 'Humein aisa nahi karna chahiye. Yeh ek mahan kaidi hai!' },
        { speaker: 'SECOND SOLDIER', lines: 'Jagah do! Antony ko batao ki Brutus pakda gaya hai.' },
        { speaker: 'FIRST SOLDIER', lines: 'Main khabar batata hoon. General aa gaye.\n—Brutus pakda gaya hai, Brutus pakda gaya hai, mere maalik.' },
        { speaker: 'ANTONY', lines: 'Woh kahan hai?' },
        { speaker: 'LUCILLIUS', lines: 'Surakshit hai, Antony. Brutus bilkul surakshit hai.\nMain tumhe vishwas dilata hoon ki koi bhi dushman\nmahan Brutus ko kabhi zinda nahi pakad payega.\nBhagwan use aisi sharam se bachaye!\nJab tum use dhoondoge, chahe zinda ya murda,\nWoh Brutus ki tarah hi paya jayega, apne aap ki tarah.' },
        { speaker: 'ANTONY', lines: 'Yeh Brutus nahi hai, dost, lekin main tumhe vishwas dilata hoon,\nyeh usse kam keemat ka inaam nahi hai. Is aadmi ko surakshit rakho.\nIse har tarah ki meherbaani do. Main aise logon ko\napna dost banana pasand karunga, na ki dushman. Aage badho,\naur dekho ki Brutus zinda hai ya mar gaya hai,\naur Octavius ke tent mein humein khabar do\nki sab kuch kaise hua hai.' },
    ]
};
const descriptionVersions = {
    Shakespearean: "In the heat of battle, loyalty is put to the test. Cato makes a valiant last stand, while Lucillius risks all by impersonating Brutus, leading to a surprising encounter with Antony.",
    'Normal English': "As the battle rages, acts of bravery and loyalty shine through. Young Cato dies fighting for his family's name, while Lucillius pretends to be Brutus to save his commander, leading to an unexpected outcome.",
    Hinglish: "Yuddh ke maidan mein, wafadari ki pariksha hoti hai. Cato ek bahadur aakhri ladai ladta hai, jabki Lucillius Brutus hone ka natak karke sab kuch daanv par laga deta hai, jisse Antony ke saath ek anokha samna hota hai."
};
                ...
                <div style={styles.mainContentContainer}>
                    <div style={styles.card}>
                        ...
                        <a style={styles.breadcrumbButton} href="/studymaterial/class9icse/Class9icseEnglish">Julius Caesar</a>
                            <h1 style={styles.sceneTitle}>Act V, Scene 4</h1>
                            ...
                            <div style={styles.dialogueColumn}>
                                <div style={styles.dialogueCard}>
                                    {dialogueContent.map((entry, index) => {
                                        const isNoble = ['BRUTUS', 'CATO', 'LUCILLIUS', 'ANTONY'].includes(entry.speaker);
...
{activeTab === "summary" && (
            <div style={styles.summaryCard}>
              <div style={styles.summaryHeader}>
                <Class9icseEnglishAct5Scene4Summary />
              </div>
            </div>
          )}
          ...
          {activeTab === "qa" && (
            <div style={styles.questionSection}>
              <Class9icseEnglishAct5Scene4Questions />
            </div>
          )}
                </div>
            </main>
